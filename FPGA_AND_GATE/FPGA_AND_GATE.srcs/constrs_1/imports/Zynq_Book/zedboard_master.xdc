...
create_clock -period 10.000 -name GCLK -waveform {0.000 5.000} GCLK

# ----------------------------------------------------------------------------
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN Y11  [get_ports {JA1}];  # "JA1"
#set_property -dict { PACKAGE_PIN AA11 IOSTANDARD LVCMOS33 PULLDOWN TRUE } [get_ports sig1]
#set_property -dict { PACKAGE_PIN AA9 IOSTANDARD LVCMOS33 PULLDOWN TRUE } [get_ports sig2]
...
#set_property -dict { PACKAGE_PIN W11 IOSTANDARD LVCMOS33 PULLDOWN TRUE } [get_ports sig1]
#set_property -dict { PACKAGE_PIN W8 IOSTANDARD LVCMOS33 PULLDOWN TRUE } [get_ports sig2]
...
#set_property PACKAGE_PIN AB7 [get_ports sig1];  
#set_property IOSTANDARD LVCMOS33 [get_ports sig1];
#set_property PACKAGE_PIN Y4 [get_ports sig2]; 
#set_property IOSTANDARD LVCMOS33 [get_ports sig2];
#ends here
...
#signals coincidence LED (2nd from the right):
...
#set_property PACKAGE_PIN P16 [get_ports button1];  # "BTNC"
#set_property IOSTANDARD LVCMOS33 [get_ports button1];
#set_property PACKAGE_PIN R16 [get_ports button2];  # "BTND"
...
set_property -dict { PACKAGE_PIN L22 IOSTANDARD LVCMOS25} [get_ports {FMC_LA06_N}];  # "FMC-LA06_N"
set_property -dict { PACKAGE_PIN L21 IOSTANDARD LVCMOS25} [get_ports {FMC_LA06_P}];  # "FMC-LA06_P"
#set_property PACKAGE_PIN T17 [get_ports {FMC_LA07_N}];  # "FMC-LA07_N"
set_property -dict { PACKAGE_PIN T16 IOSTANDARD LVCMOS25} [get_ports {FMC_LA07_P}];  # "FMC-LA07_P"
...
set_property -dict { PACKAGE_PIN P21 IOSTANDARD LVCMOS25} [get_ports {FMC_LA12_N}];  # "FMC-LA12_N"
set_property -dict { PACKAGE_PIN P20 IOSTANDARD LVCMOS25} [get_ports {FMC_LA12_P}];  # "FMC-LA12_P"
set_property -dict { PACKAGE_PIN M17 IOSTANDARD LVCMOS25} [get_ports {FMC_LA13_N}];  # "FMC-LA13_N"
...
set_property -dict { PACKAGE_PIN C20 IOSTANDARD LVCMOS25} [get_ports {FMC_LA18_CC_N}];  # "FMC-LA18_CC_N"
set_property -dict { PACKAGE_PIN D20 IOSTANDARD LVCMOS25} [get_ports {FMC_LA18_CC_P}];  # "FMC-LA18_CC_P"
#set_property PACKAGE_PIN G16 [get_ports {FMC_LA19_N}];  # "FMC-LA19_N"
set_property -dict { PACKAGE_PIN G15 IOSTANDARD LVCMOS25} [get_ports {FMC_LA19_P}];  # "FMC-LA19_P"
...
set_property -dict { PACKAGE_PIN D15 IOSTANDARD LVCMOS25} [get_ports {FMC_LA23_N}];  # "FMC-LA23_N"
set_property -dict { PACKAGE_PIN E15 IOSTANDARD LVCMOS25} [get_ports {FMC_LA23_P}];  # "FMC-LA23_P"
